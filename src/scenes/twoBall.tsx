...
import { TwoBallsPerformance } from "../figures/twoBalls";
import { Root, Text } from "@react-three/uikit";
import { Button } from "@react-three/uikit-default";

export function TwoBallsScene({ scene }: { scene: [string, Dispatch<SetStateAction<string>>] }) {
    ...
    return (
        <group>
            ...
            <group position={[1, 1, -4]}>
                <Root>
                    <Button backgroundColor={"white"} onClick={() => setScene("home")}>
                        <Text color={"black"} onClick={() => setScene("home")}>
                            Accueil
                        </Text>
                    </Button>
                </Root>
