                ...
                <Root gap={32} alignItems={"center"}>
                    <Container alignItems="center" gap={12} borderRadius={8}>
                        <Toggle
                            ...
                            borderWidth={1.5}
                            checked={loop}
                            onCheckedChange={(checked) => onLoopToggle(checked)}
                        >
                            <Infinity width={16} height={16} />
                        </Toggle>
                    </Container>
                    <Container flexDirection="row" alignItems="center" gap={20} borderRadius={8}>
                        <Button
                            variant="outline"
                        ...
                        >
                            <Play
                                width={16}
                                height={16}
                                display={status !== "playing" ? "flex" : "none"}
                            />
                            <Pause
                                width={16}
                                height={16}
                ...
                <Root>
                    <Container alignItems="center" gap={12} borderRadius={8}>
                        <Toggle
                            borderColor={"black"}
                            borderWidth={1.5}
                            checked={speedSliderActive}
                            onCheckedChange={() => setSpeedSliderActive(!speedSliderActive)}
                        >
                            <Gauge width={16} height={16} />
                        </Toggle>
                        <Container
                            display={speedSliderActive ? "flex" : "none"}
                            alignItems={"center"}
                            gap={12}
                        >
                            <Text width={50} fontWeight={"bold"} color={"white"}>
